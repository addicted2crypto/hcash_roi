...
const FACILITIES = [
  // elecRate = hCASH per kWh (confirmed from official Build Calculator Apr 4 2026)
  { id:"l1", lvl:1, name:"Lv.1", grid:"2×2", slots:4,  powerW:400,   elecRate:8.69, cooldownD:0,  costAvax:2, totalHcash:0,     color:"#4ade80" },
  { id:"l2", lvl:2, name:"Lv.2", grid:"2×3", slots:6,  powerW:1000,  elecRate:6.98, cooldownD:3,  costAvax:0, totalHcash:500,   color:"#22d3ee" },
  { id:"l3", lvl:3, name:"Lv.3", grid:"3×3", slots:9,  powerW:2000,  elecRate:6.11, cooldownD:7,  costAvax:0, totalHcash:3000,  color:"#818cf8" },
  { id:"l4", lvl:4, name:"Lv.4", grid:"3×4", slots:12, powerW:6000,  elecRate:6.99, cooldownD:14, costAvax:0, totalHcash:10500, color:"#f472b6" },
  { id:"l5", lvl:5, name:"Lv.5", grid:"4×4", slots:16, powerW:15000, elecRate:3.50, cooldownD:14, costAvax:0, totalHcash:25500, color:"#fbbf24" },
  { id:"l6", lvl:6, name:"Lv.6", grid:"5×5", slots:24, powerW:22500, elecRate:3.52, cooldownD:14, costAvax:0, totalHcash:50000, color:"#f43f5e" },
];
